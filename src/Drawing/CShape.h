...
SHAPE_GETTER_START(className) PTR_ASSIGN(widthEtc, this->w_name); SHAPE_PROPERTY_END \
SHAPE_SETTER_START(className) this->w_name = widthEtc;  SHAPE_PROPERTY_END

#define PREF_WH_SHAPE_PROPERTOR(className) \
SHAPE_GETTER_START(className) PTR_ASSIGN(widthEtc, this->width); PTR_ASSIGN(height, this->height);  SHAPE_PROPERTY_END \
SHAPE_SETTER_START(className) this->width = widthEtc; this->height = height;  SHAPE_PROPERTY_END
