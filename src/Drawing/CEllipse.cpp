...
SHAPE_CLASS_SAMPLE_ARGS_CONSTRUCTOR_START(CEllipse, SHAPE_PROPERTY_WIDTH, SHAPE_PROPERTY_HEIGHT)
SHAPE_CLASS_SAMPLE_ARGS_CONSTRUCTOR_END(ELLIPSE, width(width), height(height))
SHAPE_CLASS_FULL_ARGS_CONSTRUCTOR_START(CEllipse, SHAPE_PROPERTY_WIDTH, SHAPE_PROPERTY_HEIGHT)
